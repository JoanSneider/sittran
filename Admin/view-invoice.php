			...
			<div id="page-wrapper">
				<div class="main-page">
					<div class="tables" id="exampl">
						...
						$ret = mysqli_query($con, "select DISTINCT  tblinvoice.PostingDate,tblcustomers.Name,tblcustomers.Email,tblcustomers.Placa, tblcustomers.MobileNumber,tblcustomers.Gender
						from  tblinvoice 
						...
						?>
							<div class="table-responsive bs-example widget-shadow">
								<h4>Factura N° <?php echo $invid; ?></h4>
