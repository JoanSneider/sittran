  ...
  if(isset($_POST['submit']))
    {
      ...
      else { $msg="Algo salió mal. Inténtalo de nuevo";}
    }
?>
<!DOCTYPE HTML>
<html>
  <head>
    <title>Detalle de Agenda</title>
  ...
  <body class="cbp-spmenu-push">
    <div class="main-content">
      ...
      <div id="page-wrapper">
        <div class="main-page">
          <div class="tables">
            <h3 class="title1">Detalle de Agenda</h3>
            <div class="table-responsive bs-example widget-shadow">
              <p style="font-size:16px; color:red" align="center"> <?php if($msg){echo $msg;} ?></p>
              <h4>Ver Agenda:</h4>
              <?php
              $cid=$_GET['viewid'];
              $ret=mysqli_query($con,"select * from tblappointment where ID='$cid'");$cnt=1;
              while ($row=mysqli_fetch_array($ret)) {
                ...
                <table class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td> 
                      <?php
                      if($row['Status']=="1"){echo "Aceptado";}
                      if($row['Status']=="2"){echo "Rechazado";};
                      ?>
                    </td>
                  </tr>
                </table>
